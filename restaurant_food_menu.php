...
function func_save($form_data = null)
{
    ...
    if ($form_data['id'] == 0) {
        ...
        return $app->database_lib->insert('food_menu', $data);
    }
    // หากไม่ใช่ ก็คือการ อัพเดต
        ...
        return $app->database_lib->update('food_menu', $data, $where);
    }
}
...
function func_delete($id = 0)
{
    ...
    return $app->database_lib->delete('food_menu', $where);
}
?>
...
function controller_edit()
{
    ...
    $app->form_validation_lib->set_rules('title', 'เมนูอาหาร', 'required');
